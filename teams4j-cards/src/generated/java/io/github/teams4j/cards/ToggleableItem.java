...
public sealed interface ToggleableItem permits ActionSet, Column, ColumnSet, Container, FactSet, Image, ImageSet, InputChoiceSet, InputDate, InputNumber, InputText, InputTime, InputToggle, Media, RichTextBlock, Table, TextBlock {
    /**
