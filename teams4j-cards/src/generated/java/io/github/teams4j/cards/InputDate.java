 ...
 * @param type Must be `Input.Date`
 * @param max Hint of maximum value expressed in YYYY-MM-DD(may be ignored by some clients).
 * @param min Hint of minimum value expressed in YYYY-MM-DD(may be ignored by some clients).
 * @param placeholder Description of the input desired. Displayed when no selection has been made.
 * @param value The initial value for this field expressed in YYYY-MM-DD.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonTypeName("Input.Date")
public record InputDate(@JsonProperty("id") @Nullable String id,
     ...
     */
    public static final String TYPE = "Input.Date";
    ...
    /**
     * Creates a builder for {@link InputDate}.
     */
    ...
    /**
     * Fluent builder for {@link InputDate}.
     */
    public static final class Builder {
        ...
        @Nullable
        private String type = InputDate.TYPE;
        ...
        /**
         * Builds the {@link InputDate}.
         *
         * @throws NullPointerException if a property the schema requires was not set
         */
        public InputDate build() {
            Objects.requireNonNull(id, "id is required");
            return new InputDate(id, errorMessage, isRequired, label, labelPosition, labelWidth, inputStyle, fallback, height, separator, spacing, isVisible, requires, type, max, min, placeholder, value);
        }
    }
}
