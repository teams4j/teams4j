 ...
 * @param type Must be `Input.Time`
 * @param max Hint of maximum value expressed in HH:MM (may be ignored by some clients).
 * @param min Hint of minimum value expressed in HH:MM (may be ignored by some clients).
 * @param placeholder Description of the input desired. Displayed when no time has been selected.
 * @param value The initial value for this field expressed in HH:MM.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonTypeName("Input.Time")
public record InputTime(@JsonProperty("id") @Nullable String id,
        ...
        @JsonProperty("type") @Nullable String type, @JsonProperty("max") @Nullable String max,
     ...
     */
    public static final String TYPE = "Input.Time";
    ...
    /**
     * Creates a builder for {@link InputTime}.
     */
    ...
    /**
     * Fluent builder for {@link InputTime}.
     */
    public static final class Builder {
        ...
        @Nullable
        private String type = InputTime.TYPE;
        ...
        /**
         * Builds the {@link InputTime}.
         *
         * @throws NullPointerException if a property the schema requires was not set
         */
        public InputTime build() {
            Objects.requireNonNull(id, "id is required");
            return new InputTime(id, errorMessage, isRequired, label, labelPosition, labelWidth, inputStyle, fallback, height, separator, spacing, isVisible, requires, type, max, min, placeholder, value);
        }
    }
}
