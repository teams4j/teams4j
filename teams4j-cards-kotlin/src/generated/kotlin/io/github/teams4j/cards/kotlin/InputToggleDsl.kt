...
/**
 * Builds a [InputToggle].
 *
 * Lets a user choose between two options.
 */
@CardDsl
public class InputToggleDsl internal constructor() {
     ...
     */
    public var valueOff: String? = null

    /**
     * The value when toggle is on
     */
    public var valueOn: String? = null
    ...
    internal fun build(): InputToggle = InputToggle.builder()
        .id(id)
