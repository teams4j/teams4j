 ...
 */
@CardDsl
public open class TargetElementScope internal constructor() {
    ...
    /** Same, with `elementId` set. */
    public fun targetElement(elementId: String, block: TargetElementDsl.() -> Unit = {}) {
        values += TargetElementDsl()
            .apply {
